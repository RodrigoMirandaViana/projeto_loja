...
namespace ProjetoLoja.Controllers
{
    public class ProdutoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProdutoID,Nome,Descricao,Preco,Disponibilidade,CategoriaID")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProdutoID,Nome,Descricao,Preco,Disponibilidade,CategoriaID")] Produto produto)
        {
            if (ModelState.IsValid)
            {
